...
import 'package:maak/screens/home_screen/pages/ads/add_new_ad2.dart';
...
class AdsByAdminPage extends StatelessWidget {
  AdsByAdminPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AdsByAdminViewModel>(builder: (_, viewModel, child) {
                    ...
                    child: LoginPage(
                      onLoginComplete: () {
                        Get.to(() => ChangeNotifierProvider(
                              create: (_) => AddNewAdsAppViewModel(),
                              child: AddNewAdPage(),
                            ));
                      },
                    ),
